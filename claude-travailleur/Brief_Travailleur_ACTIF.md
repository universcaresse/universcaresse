...
> 🔴 **Un seul trouve/remplace à la fois — attendre le OK de Jean-Claude avant le suivant**
...
- **Livrer deux trouve/remplace en même temps sans attendre le OK entre les deux**
...
## ✅ CHANGEMENTS — SESSION 19 MARS 2026 (après-midi)
- Section "Votre guide rapide" — intégrée dans `index.html` via tableau desktop + accordéon mobile
