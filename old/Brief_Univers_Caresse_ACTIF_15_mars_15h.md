...
- [ ] **Mode maintenance — fond transparent** — `var(--creme)` n'existe pas. Remplacer par `var(--blanc)` dans `style.css` (règle `#page-maintenance { background: ... }`)
...
- [ ] **Problème de la section Le savon artisanal** — à investiguer
- [ ] **Affichage avec les filtres** — à investiguer
- [ ] **Uniformité dans les titres de pages** — à revoir
- [ ] **Changement des boutons pour X et point sur fiche produit**
- [ ] **Retour en haut quand on clique sur un item du menu**
