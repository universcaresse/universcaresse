...
- [ ] **Changement des boutons pour X et point sur fiche produit** — RÉGLÉ
- [ ] **Taille du texte mobile** — paragraphes trop grands sur iPhone — à revoir
- [ ] **Accroche catalogue** — ajouter une courte phrase sous "Nos collections"
...
- Scroll vers le haut automatique dans `naviguer()`
