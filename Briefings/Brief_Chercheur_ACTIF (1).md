...
- Dédupliqué par INCI — priorité PA > MH — sans INCI : dédup par Nom
- Source indiquée : Purearome ou MH
- Colonnes détectées dynamiquement via en-tête (compatible PA et MH)
...
**Décision légale :**
- La source du INCI est le fournisseur (PA ou MH) — c'est leur obligation légale
...
- Priorité INCI : Purearome > Les Mauvaises Herbes — EU CosIng écarté comme source
...
- Nommage onglets : `Scraping_PA_v4`, `Scraping_MH`
