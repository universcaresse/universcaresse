...
**Fichier `code.gs` :**
- `getSourcesInci()` — déduplication par nom : garde la ligne avec catégorie confirmée dans `Config_INCI` (statut `oui`), sinon la première occurrence. Règle le problème des produits PA dans plusieurs catégories (ex: argiles apparaissaient aussi dans "Colorants et Pigments" et "Ingrédients Secs")
...
- [x] **Page INCI — colonnes tableau** ✅ fait session 26 mars — Nom 25%, INCI 35%, Catégorie UC 25%, Actions 15%
...
*Univers Caresse — Confidentiel — 26 mars 2026*
