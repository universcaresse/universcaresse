...
### Version V2-002 — 2026-04-04 — 06h26
...
6. Dire ce qu'on fait dans cette session — exemple : *"On commence les sheets V2. Collections et Lignes en premier."*
...
- Famille = regroupement visuel de gammes — appliqué après la création, pas pendant
...
### Sheets V2 — 28 onglets dans l'ordre logique
**Structure** : Collections, Gammes, Familles
**Produits** : Gammes_Base, Produits, Produits_Ingredients, Produits_Formats, Emballages
**Médias** : Mediatheque
**Chaîne INCI** : Scraping_PA, Scraping_MH, Scraping_Arbressence, Scraping_DE, Mapping_Fournisseurs, Categories_UC, Ingredients_INCI
**Config** : Config
**Fournisseurs & Achats** : Fournisseurs, Formats_Ingredients, Achats_Entete, Achats_Lignes
**Stock** : Stock_Ingredients (calculé automatiquement)
**Production** : Lots
**Ventes** : Ventes_Entete, Ventes_Lignes
**Config site** : Contenu

### Données
- IDs stables partout — jamais de relation par texte
- Collections et Gammes dans deux sheets séparées
- Produits_Ingredients = sheet séparée (une ligne par ingrédient par produit)
- Stock calculé automatiquement à partir des achats et des lots
...
*Univers Caresse — Document confidentiel — V2-001 — 2026-04-04 — 06h26*
