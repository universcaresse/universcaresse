...
- ⚠️ **Question ouverte — à trancher avant de coder :** le modal écrit-il directement dans `Ingredients_INCI` (sautant les sheets de scraping) ou passe-t-il par les sheets intermédiaires ? Arguments pour direct : Chantal valide visuellement avant de confirmer. Arguments pour intermédiaire : cohérence du flux, traçabilité.
