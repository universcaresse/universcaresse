...
6. **Bug collections public** — corrigé : `initSPA()` avant données, `chargerCatalogue()` utilise mémoire
7. **Modal produit iPad portrait** — corrigé : layout côte à côte, bloc jaune pleine hauteur, ✕ dans le modal
8. **Modal produit iPad paysage** — corrigé : même corrections
9. **Avertissements fiche recette** — image manquante retiré, surgraissage conditionnel (ligne "savon"), formats incomplets signalés, ⚠️ sur ingrédient sans INCI
...
3. ~~Modal produit responsive iPhone/iPad~~ ✅ — portrait et paysage corrigés
...
*Univers Caresse — Confidentiel — v19 — 31 mars 2026*
